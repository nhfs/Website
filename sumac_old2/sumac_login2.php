...
function sumac_login2($pkg,$buttoncode,$onlynewuser,$organisationDocument,$accountDocument,$previousRequest,$responseMessage,$goBackLink)
{
	if ($accountDocument == null)
	{
		return sumac_login2_personal_section($pkg,$buttoncode,$onlynewuser,$organisationDocument,$previousRequest,$responseMessage,$goBackLink);
	}
	else
	{
...
function sumac_login2_personal_section($pkg,$buttoncode,$onlynewuser,$organisationDocument,$previousRequest,$responseMessage,$goBackLink)
{
	...
	$html .= sumac_login2_personal_table($pkg,$buttoncode,$onlynewuser,$organisationDocument,$previousRequest,$responseMessage);
	$html .= '</div>'.PHP_EOL;
	return $html;
}

function sumac_login2_personal_table($pkg,$buttoncode,$onlynewuser,$organisationDocument,$previousRequest,$responseMessage)
{
	...
	$html .= sumac_geth2_sumac_subtitle($pkg,(($onlynewuser === false)?'NH2':'NH7'),1);
	$html .= sumac_geth2_sumac_subtitle($pkg,(($onlynewuser === false)?'NH3':'NH8'),2);

	$html .= sumac_login2_name_and_address_table($pkg,$buttoncode,$onlynewuser,$organisationDocument);
	$html .= '</td>'.PHP_EOL;
...
function sumac_login2_name_and_address_table($pkg,$buttoncode,$onlynewuser,$organisationDocument)
{
