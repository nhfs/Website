...
// 127.0.0.1/sumac/newsletter.php/?L=http%3A%2F%2Fweather.gc.ca%2Fcity%2Fpages%2Fon-128_metric_e.html&U=a_sumac_user_id
	...
	$source = sumac_get_parameter(null,'source','SOURCE','Source');
	$port = sumac_get_parameter('80','port','PORT','Port');
	$userdata = sumac_get_parameter($_SERVER["HTTP_HOST"],'userdata','USERDATA','UserData');
...
//what if the linkaddr needs http//:?
	exit();
?>
