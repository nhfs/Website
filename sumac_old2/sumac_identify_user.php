...
include_once 'sumac_donation2.php';
				if (sumac_donation2('requestpassword',$status,'sumac_identify_user.php',null) == false)
				{
					echo sumac_getAbortHTML();
					sumac_destroy_session('');
				}
			}
			else	// all other packages retry through old user login code
			{
include_once 'sumac_user_login.php';
	...
	else if (isset($_POST['adduser']) || isset($_POST['pay']) || isset($_POST['submitform']) || isset($_POST['signup']))
	{
include_once 'sumac_xml.php';
...
//
		...
		{
include_once 'sumac_donation2.php';
			if (sumac_donation2($postedFunction,$_SESSION[SUMAC_SESSION_REQUEST_ERROR],'sumac_identify_user.php',null) == false)
			{
				echo sumac_getAbortHTML();
				sumac_destroy_session('');
			}
...
include_once 'sumac_singleform2.php';
			if (sumac_singleform2($postedFunction,$_SESSION[SUMAC_SESSION_REQUEST_ERROR],'sumac_identify_user.php',null,null) == false)
			{
				echo sumac_getAbortHTML();
				sumac_destroy_session('');
			}
		...
		{
include_once 'sumac_signup2.php';
			if (sumac_signup2($postedFunction,$_SESSION[SUMAC_SESSION_REQUEST_ERROR],'sumac_identify_user.php') == false)
			{
				echo sumac_getAbortHTML();
				sumac_destroy_session('');
			}
...
include_once 'sumac_select_directory.php';
		...
		else if ($_SESSION[SUMAC_SESSION_ACTIVE_PACKAGE] == SUMAC_PACKAGE_DONATION2)
		{
			...
			{
include_once 'sumac_donation2.php';
				if (sumac_donation2($postedFunction,'','sumac_donation2_made.php',$accountDocument) == false)
				{
					echo sumac_getAbortHTML();
					sumac_destroy_session('');
				}
		...
		else if ($_SESSION[SUMAC_SESSION_ACTIVE_PACKAGE] == SUMAC_PACKAGE_SINGLEFORM2)
		{
			...
			{
				$combinedWithLogin = true;
				require 'sumac_singleform2_submitted.php';
				return;
			}
			else
			{
include_once 'sumac_singleform2.php';
				if (sumac_singleform2($postedFunction,'','sumac_singleform2_submitted.php',$accountDocument,null) == false)
				{
					echo sumac_getAbortHTML();
					sumac_destroy_session('');
				}
		...
		else if ($_SESSION[SUMAC_SESSION_ACTIVE_PACKAGE] == SUMAC_PACKAGE_SIGNUP2)
		{
			...
			echo sumac_geth2_exit_package_page('signup2',sumac_geth2_spantext('signup2','H1'),'L4',SUMAC_INFO_FOOTER_SUMAC_DEPART2_LINK,SUMAC_INFO_FOOTER_SUMAC_DEPART2_TEXT);
		}
