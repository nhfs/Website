...
include_once 'sumac_donation2.php';
		if (isset($_SESSION[SUMAC_SESSION_ACCOUNT_DETAILS]))	//the user is already logged in
		{
			if (sumac_donation2('','','sumac_donation2_made.php',null) == false)
			{
				echo sumac_getAbortHTML();
				sumac_destroy_session('');
			}
		...
		{
			if (sumac_donation2('','','sumac_identify_user.php',null) == false)
			{
				echo sumac_getAbortHTML();
				sumac_destroy_session('');
			}
...
include_once 'sumac_singleform2.php';
		if (isset($_SESSION[SUMAC_SESSION_ACCOUNT_DETAILS]))	//the user is already logged in
		{
			if (sumac_singleform2('','','sumac_singleform2_submitted.php',null,null) == false)
			{
				echo sumac_getAbortHTML();
				sumac_destroy_session('');
			}
		...
		{
			if (sumac_singleform2('','','sumac_identify_user.php',null,null) == false)
			{
				echo sumac_getAbortHTML();
				sumac_destroy_session('');
			}
...
include_once 'sumac_signup2.php';
		if (sumac_signup2('','','sumac_identify_user.php') == false)
		{
			echo sumac_getAbortHTML();
			sumac_destroy_session('');
		}
