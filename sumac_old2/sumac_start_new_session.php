...
include_once 'sumac_donation2.php';
		$message = (isset($forcedrestart)) ? $forcedrestart['message'] : '';
		if (sumac_donation2('',$message,'sumac_identify_user.php',null) == false)
		{
			echo sumac_getAbortHTML();
			sumac_destroy_session('');
		}
...
include_once 'sumac_singleform2.php';
		$message = (isset($forcedrestart)) ? $forcedrestart['message'] : '';
		if (sumac_singleform2('',$message,'sumac_identify_user.php',null,null) == false)
		{
			echo sumac_getAbortHTML();
			sumac_destroy_session('');
		}
...
include_once 'sumac_signup2.php';
		$message = (isset($forcedrestart)) ? $forcedrestart['message'] : '';
		if (sumac_signup2('',$message,'sumac_identify_user.php') == false)
		{
			echo sumac_getAbortHTML();
			sumac_destroy_session('');
		}
