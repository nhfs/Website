...
function sumac_getHTMLFormForZeroCostOrderDetails($organisationDocument)
{
	...
	$html .= '<tr><td colspan="2" align="left"><input type="submit" name="buycourse" value="' . $_SESSION[SUMAC_STR]["CL25"] . '"' .
					...
					'<input type="hidden" name="mincentscharge" value="0" />' .
					'<input type="hidden" name="fullcentscharge" value="0" />' .
					'</td></tr>' . "\n";
	$html .= '</table>' . "\n";
	return $html;
}
...
{
	$html = '<table>' . "\n";
	$html .= '<tr><td align="left"><input type="submit" name="buycourse" value="' . $_SESSION[SUMAC_STR]["CL25"] . '" />' .
					'<input type="hidden" name="cardtype" value="" />' .
					'<input type="hidden" name="cardnumber" value="" />' .
					'<input type="hidden" name="cardsecurity" value="" />' .
					'<input type="hidden" name="cardexpmonth" value="" />' .
