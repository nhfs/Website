...
//this is 'raods_start.php'
//control is passed here by a link in the organisation website
//we could also get here via the 'Back' button from the donate page
...
include_once 'sumac_set_parameters.php';
	$_SESSION[SUMAC_SESSION_SINGLE_PACKAGE] = SUMAC_PACKAGE_DONATION;
	if (sumac_set_parameters(SUMAC_PACKAGE_DONATION) === false) return;
