...
include_once 'sumac_xml.php';
		...
		else
		{
			...
			{
				echo sumac_getFunctionCompletedHTML($_SESSION[SUMAC_STR]["MB2"],$responseMessage,$responseDocument,false,false,true);
			}
...
include_once 'sumac_renew_membership.php';
			...
			{
				echo sumac_getFunctionCompletedHTML($_SESSION[SUMAC_STR]["MB1"],$responseMessage,$responseDocument,false,false,true);
			}
		}
	}
