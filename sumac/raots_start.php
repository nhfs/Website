...
//this is 'raots_start.php'
//control is passed here by a link in the theatre website
//we could also get here via the 'Back' button from the event selection page

//it always displays the event selection page
...
include_once 'sumac_set_parameters.php';
	$_SESSION[SUMAC_SESSION_SINGLE_PACKAGE] = SUMAC_PACKAGE_TICKETING;
	if (sumac_set_parameters(SUMAC_PACKAGE_TICKETING) === false) return;
...
include_once 'sumac_http.php';
	$variableValues = SUMAC_REQUEST_KEYWORD_REQUEST . '=' . SUMAC_REQUEST_PARAM_ORGANISATION .
						'&' . SUMAC_REQUEST_KEYWORD_INCLUDE . '=' . SUMAC_REQUEST_INCLUDE_THEATRE .
						$_SESSION[SUMAC_SESSION_WEBSITE_DATA];
