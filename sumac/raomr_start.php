...
//this is 'raomr_start.php'
//control is passed here by a link in the organisation website
//we could also get here via the 'Back' button from the renewal page
...
include_once 'sumac_set_parameters.php';
	$_SESSION[SUMAC_SESSION_SINGLE_PACKAGE] = SUMAC_PACKAGE_MEMBERSHIP;
	if (sumac_set_parameters(SUMAC_PACKAGE_MEMBERSHIP) === false) return;
...
//	{
//		if (sumac_execLogin('','sumac_identify_user.php',true,true) == false)
//		{
//			echo sumac_getAbortHTML();
//			sumac_destroy_session('');
//		}
...
//	else
//	{
//		if (sumac_execLogin('','sumac_identify_user.php',false,true) == false)
//		{
//			echo sumac_getAbortHTML();
//			sumac_destroy_session('');
//		}
