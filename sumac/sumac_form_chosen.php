...
//echo 'filledform=' . $filledform  . '<br />';
		$formTemplateDocument = sumac_loadFormTemplateDocument($source,$port,SUMAC_REQUEST_PARAM_FILLEDFORM,$filledform,null);
	}
...
//echo 'newform=' . $newform  . '<br />';
		$formTemplateDocument = sumac_loadFormTemplateDocument($source,$port,SUMAC_REQUEST_PARAM_NEWFORM,$newform,null);
	}
