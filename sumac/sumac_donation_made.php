...
include_once 'sumac_xml.php';
		...
		else
		{
			...
			{
				echo sumac_getFunctionCompletedHTML($_SESSION[SUMAC_STR]["DB2"],$responseMessage,$responseDocument,false,false,true);
			}
...
include_once 'sumac_make_donation.php';
			...
			{
				echo sumac_getFunctionCompletedHTML($_SESSION[SUMAC_STR]["DB1"],$responseMessage,$responseDocument,false,false,true);
			}
		}
	}
